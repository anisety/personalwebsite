          ...
          >
            ...
            <div className="contact-details-list">
              <div className="contact-detail-item">
                <div className="contact-icon-container-blue">
                  <svg className="contact-detail-icon-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="contact-detail-item">
                <div className="contact-icon-container-purple">
                  <svg className="contact-detail-icon-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div>
                  ...
                  <p className="about-stat-label">{personal.location}</p>
                </div>
              </div>
              ...
              <div className="contact-detail-item">
                ...
                <div>
                  <h4 className="contact-detail-title">Response Time</h4>
                  <p className="about-stat-label">Usually within 24 hours</p>
                </div>
              </div>
            </div>
            ...
            {/* Social Links */}
            <div>
              <h4 className="contact-follow-title">Follow me</h4>
              <div className="about-social-links">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="contact-social-link-website"
                >
